...
# ¡El paso clave! Compilamos el frontend aquí durante la fase de construcción
# para no sobrecargar el servidor en tiempo de ejecución.
RUN reflex export --frontend-only

# Exponemos el puerto estándar que usa Reflex en producción
EXPOSE 8000
